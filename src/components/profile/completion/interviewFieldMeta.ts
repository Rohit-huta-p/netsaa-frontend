...
const RULES: Rule[] = [
  ...
  { test: /verified email|verify.*email|backup email/i, build: (label) => ({ id: 'email', label, chipLabel: 'Verify email', section: 'verify', question: 'Add a backup email so you never lose access to your account.', inputType: 'verify', playbillSlot: 'none', mirrorRelevant: true }) },
];
