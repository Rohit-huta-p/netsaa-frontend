...
export const StepInput = ({ label, value, onChangeText, icon, prefix, error, ...props }: StepInputProps) => (
    <View style={{ marginBottom: 16 }}>
        ...
        <View style={{
            ...
            <TextInput
                ...
                style={{ flex: 1, color: C.w80, fontSize: 15, paddingHorizontal: (icon || prefix) ? 8 : 0, height: '100%', outlineStyle: 'none' } as any}
                {...props}
            />
        </View>
    </View>
